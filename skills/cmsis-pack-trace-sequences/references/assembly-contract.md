...
```xml
<!-- CMSIS-PACK-TRACE: ADD-DEVICE-SPECIFIC-START-HERE BEGIN -->
<!-- CMSIS-PACK-TRACE: ADD-DEVICE-SPECIFIC-START-HERE END -->
...
```text
TraceStart:   ADD-DEVICE-SPECIFIC-START-HERE -> CORESIGHT-START
TraceCapture: ADD-DEVICE-SPECIFIC-CAPTURE-HERE -> CORESIGHT-CAPTURE
TraceFlush:   CORESIGHT-FLUSH -> ADD-DEVICE-SPECIFIC-FLUSH-HERE
TraceStop:    CORESIGHT-STOP -> ADD-DEVICE-SPECIFIC-STOP-HERE
```
